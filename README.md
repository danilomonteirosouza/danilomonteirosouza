...
I have advanced abilities in: Flutter, Dart, Figma, Bloc, Cubit, Get_it, Go_router, Clean Code, Clean Architecture, SOLID, TDD, Mocktail, Mockito, IntelliJ, VSCode, Jenkins Pipeline, Docker, Kubernetes, Lens, SonarQube, Git, GitHub, Bitbucket, Amazon AWS, HiveMQ Cloud, Jira, MySQL, PostgreSQL, DynamoDB, Ubuntu, Windows, API Restful, WebSocket’s, Scrum, Keycloack, Artificial Intelligence, Data Mining, Machine Learning, Deep Learning and Robotics with Arduino, Lora32, ESP8266, ESP32.
